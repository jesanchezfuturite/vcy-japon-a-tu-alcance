...
var middlewareSecret = "e1cef03d-db5f-4ad2-804d-e0e476b951b9";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/user/Documents/vcy-japon-a-tu-alcance/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/user/Documents/vcy-japon-a-tu-alcance/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var _page0 = () => import("./chunks/generic_BYx7WeOb.mjs");
var _page1 = () => import("./chunks/contact_DERIqkVu.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/","cacheDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/node_modules/.astro/","outDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/dist/","srcDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/src/","publicDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/public/","buildClientDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/dist/client/","buildServerDir":"file:///Users/user/Documents/vcy-japon-a-tu-alcance/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/contact","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/contact\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/contact.ts","pathname":"/api/contact","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/user/Documents/vcy-japon-a-tu-alcance/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.Ag7AGdUX.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_ktysLtM3.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/contact@_@ts":"chunks/contact_DERIqkVu.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_BYx7WeOb.mjs","/Users/user/Documents/vcy-japon-a-tu-alcance/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_C6Esx-R1.mjs","/Users/user/Documents/vcy-japon-a-tu-alcance/src/components/ContactForm.astro?astro&type=script&index=0&lang.ts":"_astro/ContactForm.astro_astro_type_script_index_0_lang.B0iC37jO.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/user/Documents/vcy-japon-a-tu-alcance/src/components/ContactForm.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`lead-form`),t=document.getElementById(`form-status`);e?.addEventListener(`submit`,async e=>{e.preventDefault();let n=new FormData(e.target),r=Object.fromEntries(n);t&&(t.textContent=`Enviando...`,t.className=`text-center text-sm font-medium text-blue-600`,t.classList.remove(`hidden`));try{if((await fetch(`/api/contact`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(r)})).ok){t&&(t.textContent=`¡Gracias! Tu itinerario se está descargando.`,t.className=`text-center text-sm font-medium text-green-600`),e.target.reset();let n=document.createElement(`a`);n.href=`/pdf/japon-a-tu-alcance.pdf`,n.download=`Itinerario-Japon-A-Tu-Alcance-2026.pdf`,document.body.appendChild(n),n.click(),document.body.removeChild(n)}else throw Error()}catch{t&&(t.textContent=`Hubo un error. Por favor intenta de nuevo.`,t.className=`text-center text-sm font-medium text-red-600`)}});"]],"assets":["/favicon.ico","/favicon.svg","/pdf/japon-a-tu-alcance.pdf","/images/chanko.webp","/images/dotonbori.webp","/images/fuji.webp","/images/fushimi.webp","/images/nozomi.webp","/images/shibuya.webp","/images/templo-antiguo.webp","/images/templos-asakusa.webp","/images/tokyo-noche.webp","/images/tunel-sagrado.webp","/images/vcy-logo.webp","/images/wakayama.webp","/_astro/index.59oyqGCQ.css","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"6m/2cA0lJT51Icl0cfHqZreLH0rWu5OjFoCYq+7RX5Y=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
